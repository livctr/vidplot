...
class RGBRenderer(Renderer):
    ...
    Args:
        ...
        resize_mode: 'fit' (keep aspect, pad), 'stretch' (fill bbox), or 'center' (no resize, center in bbox).
    ...
    def __init__(
        ...
        assert resize_mode in ('fit', 'stretch', 'center'), "resize_mode must be 'fit', 'stretch', or 'center'"
